...
public class OvertimeWorkApplyService {
	...
	public Integer getNextCheckEmployeeId(Integer overtimeWorkApplyId, Integer checkEmployeeId) {
		StringBuilder sb = new StringBuilder();
		sb.append("select oc.check_employee_id ");
		sb.append("from overtime_work_apply_check oc ");
		...
		sb.append("from overtime_work_apply_check c ");
		sb.append("where c.overtime_work_apply_id = ? ");
		sb.append("and c.check_employee_id = ?) ");
		return overtimeWorkApplyDao.findCountBySql(sb.toString(),
				new Object[] { overtimeWorkApplyId, overtimeWorkApplyId, checkEmployeeId });
	}
