...
<script src="${ctx }/resources/js/admin/employeeRole/employeeRole.js"></script>
	<form class="form-inline" role="form">
		...
		<div class="form-group  btn-group-sm" role="group" aria-label="...">
		  <button type="button" class="btn btn-default" onclick="EmployeeRole.showEdit();"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增</button>
		</div>
				...
				<tbody>
					<c:forEach var="entity" items="${page.dataList}" varStatus="status">
						<tr>
							...
							<td>${entity.employeeRoleId}</td>
							<td>${entity.employeeId}</td>
							<td>${entity.roleId}</td>
							<td>
							<button type="button" class="btn btn-default btn-sm" onclick="EmployeeRole.showEdit('${entity.employeeRoleId}');">
							  <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>编辑
							</button>
							<button type="button" class="btn btn-default  btn-sm btn-danger" onclick="EmployeeRole.deleteData('${entity.employeeRoleId}');">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="editForm">
						<input name="employeeRoleId" type="hidden" ></input>
