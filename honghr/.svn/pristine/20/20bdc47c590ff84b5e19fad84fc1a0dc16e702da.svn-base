...
<body>
	...
	<form class="form-inline" role="form">
		<div class="form-group btn-group-sm z_margin_tb">
			...
			<span class="show-lab label">出差类型:</span> 
			...
			<span class="show-lab label">出差单状态:</span> 
	...
	<!-- 模态框编辑（Modal） -->
	<div class="modal fade d_model_box" id="myModal_edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" style="overflow:hidden;">
		<div class="modal-dialog modal-show">
			<div class="modal-content">
		 		<div class="modal-header">
	                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
