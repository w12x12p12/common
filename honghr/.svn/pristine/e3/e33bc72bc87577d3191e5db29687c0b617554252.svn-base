...
<form class="form-inline" role="form">
	...
	<div class="form-group  btn-group-sm" role="group" aria-label="...">
		<button type="button" class="btn btn-default btn-search" onclick="Employee.showEdit();">
			...
			<tbody>
				<c:forEach var="entity" items="${page.dataList}" varStatus="status">
					<tr>
						...
						<td>
							<button type="button" class="btn btn-default btn-sm" onclick="Employee.reSetPwd('${entity.employeeId}');">
