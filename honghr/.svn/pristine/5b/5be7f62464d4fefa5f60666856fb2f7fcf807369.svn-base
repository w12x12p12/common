...
/**
 * @author  
 * el_bp_overtime_work_apply 表对应实体
 * 2017/12/07 04:00:57
 */
@Table(name="overtime_work_apply", pk="overtimeWorkApplyId")
public class OvertimeWorkApply extends BaseEntity implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	/***/
	private Integer overtimeWorkApplyId;
	/***/
	private String overtimeWorkApplyNum;
	/***/
	...
	/***/
	private String applyWorkContent;
	/***/
	...
	public void setOvertimeWorkApplyId(Integer value) {
		this.overtimeWorkApplyId = value;
	}
	
	public Integer getOvertimeWorkApplyId() {
		return overtimeWorkApplyId;
	}
	public void setOvertimeWorkApplyNum(String value) {
		this.overtimeWorkApplyNum = value;
	}
	
	public String getOvertimeWorkApplyNum() {
		return overtimeWorkApplyNum;
	}
	...
	public void setApplyWorkContent(String value) {
		this.applyWorkContent = value;
	}
	
	public String getApplyWorkContent() {
		return applyWorkContent;
	}
