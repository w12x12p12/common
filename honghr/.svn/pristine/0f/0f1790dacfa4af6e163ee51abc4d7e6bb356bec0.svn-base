...
/**
 * @author el_bp_absence_apply 表对应实体 2017/12/07 04:00:54
 */
@Table(name = "absence_apply", pk = "absenceApplyId")
public class AbsenceApply extends BaseEntity implements Serializable {
	...
	/***/
	private String absenceApplyNum;
	/***/
	...
	public void setAbsenceApplyNum(String value) {
		this.absenceApplyNum = value;
	}

	public String getAbsenceApplyNum() {
		return absenceApplyNum;
	}
