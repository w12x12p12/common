...
<form class="form-inline" role="form">
	<div class="form-group btn-group-sm z_margin_tb">
		...
		<span class="show-lab label">字段名:</span> 
		 <input type="text"
			name="codeName" value="${codeName }" class="form-control input-sm"
			id="" placeholder="请输入字段名进行查询">
					...
					<tr>
						...
						<td>
							<button type="button" class="btn btn-default btn-sm"
								onclick="Code.showEdit('${entity.codeId}');">
