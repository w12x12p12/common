				...
				<tbody>
					<c:forEach var="entity" items="${page.dataList}" varStatus="status">
						<tr>
							...
							<td style="max-width:80px;">${entity.applyReason}</td>
							...
							<td><button type="button" class="btn btn-default btn-sm overtime_look" data="${entity.overtimeWorkApplyId}" data-toggle="modal" data-target="#myModal_look">
