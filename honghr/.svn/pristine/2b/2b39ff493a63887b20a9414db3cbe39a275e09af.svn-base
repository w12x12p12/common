	...
	<div class="container-fluid z_index_topnav">
		<div class="navbar-header">
		  <img src="${ctx}/resources/img/index_logo.png" class="left z_logo_img">
			<a class="navbar-brand z_navbar_logo" href="${ctx}/admin/employee/personal" target="mainFrame">宏程教育GEE人事管理平台</a>
		</div>
		<div>
...
<div class="container-fluid">
	<div class="row">
		<div id="accordion" class="col-sm-3 col-md-2 sidebar z_index_left panel-group">
			<div class="menu_default panel">
				<a href="#1" class="nav-header collapsed z_collapsed" data-toggle="collapse" data-parent="#accordion">
					个人信息管理
			...
			<c:if test="${employeeKey.username == 'admin'}">  
				<div class="menu_default panel">
		          	<a href="#2" class="nav-header collapsed z_collapsed" data-toggle="collapse" data-parent="#accordion">
						基础数据管理
					<span class="pull-right glyphicon glyphicon-chevron-toggle"></span>
					</a>
			...
			<div class="menu_default panel">
				<a href="#3" class="nav-header collapsed z_collapsed" data-toggle="collapse" data-parent="#accordion">
					加班单管理
				<span class="pull-right glyphicon glyphicon-chevron-toggle"></span>
				</a>
			...
			<div class="menu_default panel">
				<a href="#4" class="nav-header collapsed z_collapsed" data-toggle="collapse" data-parent="#accordion">
					休假单管理
				<span class="pull-right glyphicon glyphicon-chevron-toggle"></span>
				</a>
			...
			<div class="menu_default panel">
				<a href="#5" class="nav-header collapsed z_collapsed" data-toggle="collapse" data-parent="#accordion">
					出差单管理
				<span class="pull-right glyphicon glyphicon-chevron-toggle"></span>
				</a>
			...
			<c:if test="${employeeKey.username == 'admin'}"> 
				<div class="menu_default panel">
					<a href="#6" class="nav-header collapsed z_collapsed" data-toggle="collapse" data-parent="#accordion">
						统计管理
					<span class="pull-right glyphicon glyphicon-chevron-toggle"></span>
					</a>
					<ul id="6" class="nav nav-list collapse z_secondmenu" style="height: 0px;">
						<li class="z_menu_li"><a href="${ctx}/admin/absenceApply/remainingLeaveHoursCount" target="mainFrame" onclick="selectMenu(this);" style="font-size:16px;color:#000;text-indent:30px;"><span>员工考勤核算</span></a></li>
					</ul>
				</div>
			</c:if> 
        </div>
