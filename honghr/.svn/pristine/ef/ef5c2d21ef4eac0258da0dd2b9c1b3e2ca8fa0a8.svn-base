...
<script src="${ctx }/resources/js/admin/permission/permission.js"></script>
	<form class="form-inline" role="form">
		...
		<div class="form-group  btn-group-sm" role="group" aria-label="...">
		  <button type="button" class="btn btn-default" onclick="Permission.showEdit();"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增</button>
		</div>
				...
				<tbody>
					<c:forEach var="entity" items="${page.dataList}" varStatus="status">
						<tr>
							...
							<td>${entity.roleId}</td>
							<td>${entity.permissionName}</td>
							<td>${entity.moduleId}</td>
							<td>
							<button type="button" class="btn btn-default btn-sm" onclick="Permission.showEdit('${entity.permissionId}');">
							  <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>编辑
							</button>
							<button type="button" class="btn btn-default  btn-sm btn-danger" onclick="Permission.deleteData('${entity.permissionId}');">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="editForm">
						<input name="permissionId" type="hidden" ></input>
						<div class="form-group">
							<label for="disabledSelect" class="col-sm-2 control-label"><b class="z_common_star">*</b>roleId</label>
							<div class="col-sm-10">
								<input class="form-control validate[required]"  name="roleId" type="text" placeholder="请输入100字以内字符" maxlength="100"></input>
							</div>
						</div>
						<div class="form-group">
							<label for="disabledSelect" class="col-sm-2 control-label"><b class="z_common_star">*</b>permissionName</label>
							<div class="col-sm-10">
								<input class="form-control validate[required]"  name="permissionName" type="text" placeholder="请输入100字以内字符" maxlength="100"></input>
							</div>
						</div>
						<div class="form-group">
							<label for="disabledSelect" class="col-sm-2 control-label"><b class="z_common_star">*</b>moduleId</label>
							<div class="col-sm-10">
								<input class="form-control validate[required]"  name="moduleId" type="text" placeholder="请输入100字以内字符" maxlength="100"></input>
							</div>
						</div>
					</form>
				</div>
