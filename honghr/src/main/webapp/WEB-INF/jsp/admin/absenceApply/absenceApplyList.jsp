...
<body>
	...
	<script type="text/javascript" src="${ctx}/resources/js/common/bootstrap-fileinput.js"></script>
	<form class="form-inline" role="form">
		<div class="form-group btn-group-sm z_margin_tb">
			<label class="sr-only" for="name">查询条件</label> 
			<span class="show-lab label">假期种类:</span> 
			...
			<span class="show-lab label">休假单状态:</span> 
	...
	<!-- 模态框编辑（Modal） -->
	<div class="modal fade d_model_box" style="overflow:hidden;" id="myModal_edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
		<div class="modal-dialog modal-show">
		 	<div class="modal-content">
		 		<div class="modal-header">
	                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
	            ...
	            <div class="modal-body">
	            	<form id="editForm" class="form-horizontal" role="form">
						...
						<div class="form-group w_edit_textArea clearfix">
							...
							<div class="col-sm-10">
								<textarea name="applyReason" class="form-control w_honghr_textArea edit_absence_show w_edit_applyReason" cols="3" placeholder="请输入休假原因" ></textarea> 
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="disabledSelect" class="col-sm-2 control-label"><b class="z_common_star">*</b>上传附件</label>
							<div class="col-sm-10">
								<div class="fileinput fileinput-new" data-provides="fileinput"  id="exampleInputUpload">
				                   <div class="fileinput-new thumbnail" style="width: 200px;height:150px;">
				                       <img id="picImg" style="width:100%;height: 150px;" src="${ctx}/resources/img/noimage.png" onerror="javascript:this.src='${ctx}/resources/img/noimage.png'" alt="" />
				                   </div>
				                   <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"></div>
				                   <div class="up_wrapper">
				                   <div class="up_middle">
				                        <span class=" btn-file up_span_box">
				                            <span class="fileinput-new"></span>
				                            <span class="fileinput-exists"></span> 
				                            <input type="file" name="pic1" id="picID" accept="image/gif,image/jpeg,image/x-png" class="up_btn"/>
				                        </span>
				                    </div>
				                   </div>
				                </div>
