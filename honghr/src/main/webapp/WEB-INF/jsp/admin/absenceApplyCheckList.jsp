...
<script src="${ctx }/resources/js/admin/absenceApplyCheck/absenceApplyCheck.js"></script>
	<form class="form-inline" role="form">
		...
		<div class="form-group  btn-group-sm" role="group" aria-label="...">
		  <button type="button" class="btn btn-default" onclick="AbsenceApplyCheck.showEdit();"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增</button>
		</div>
		...
		<div class="table-responsive">
			<table class="table table-striped">
				<thead>
					<tr>
						<th>序号</th>
						<th>absenceApplyCheckId</th>
						<th>absenceApplyId</th>
				...
				<tbody>
					<c:forEach var="entity" items="${page.dataList}" varStatus="status">
						<tr>
							...
							<td>${entity.absenceApplyCheckId}</td>
							<td>${entity.absenceApplyId}</td>
							...
							<td>
							<button type="button" class="btn btn-default btn-sm" onclick="AbsenceApplyCheck.showEdit('${entity.absenceApplyCheckId}');">
							  <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>编辑
							</button>
							<button type="button" class="btn btn-default  btn-sm btn-danger" onclick="AbsenceApplyCheck.deleteData('${entity.absenceApplyCheckId}');">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="editForm">
						<input name="absenceApplyCheckId" type="hidden" ></input>
						<div class="form-group">
							<label for="disabledSelect" class="col-sm-2 control-label"><b class="z_common_star">*</b>absenceApplyId</label>
							<div class="col-sm-10">
								<input class="form-control validate[required]"  name="absenceApplyId" type="text" placeholder="请输入100字以内字符" maxlength="100"></input>
							</div>
						</div>
						<div class="form-group">
