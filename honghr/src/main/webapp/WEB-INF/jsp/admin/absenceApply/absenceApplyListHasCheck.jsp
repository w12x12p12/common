...
<body>
	...
	<form class="form-inline" role="form">
		<div class="form-group btn-group-sm z_margin_tb">
			...
			<span class="show-lab label">休假人:</span> 
			<input type="text" class="form-control input-sm" name="applyEmployeeName" value="${absenceApplyVo.applyEmployeeName}" placeholder="请输入员工姓名">
			<span class="show-lab label">所属部门:</span>
			<select name="applyDepartmentNum" class="form-control input-sm">
				<option value="default">请选择</option>
				<c:forEach items="${departmentList}" var="department">
					<option value="${department.departmentNum}" <c:if test="${department.departmentNum == absenceApplyVo.applyDepartmentNum}">selected="selected"</c:if>>${department.departmentName}</option>
				</c:forEach>
			</select>
