...
<body>
	...
	<form id="applyForm" class="mainForm">
		...
		<div class="form-group w_honghr_input w_edit_textArea clearfix">
			...
			<div class="col-sm-10">
			 	<textarea name="applyReason" class="form-control w_honghr_textArea w_edit_applyReason" placeholder="请输入休假原因" ></textarea> 
			</div>
		</div>
		<div class="form-group w_honghr_input">
			...
			<div class="col-sm-10">
				<div class="fileinput fileinput-new" data-provides="fileinput"  id="exampleInputUpload">
                   <div class="fileinput-new thumbnail" style="width: 200px;height:150px;">
                       <img id="picImg" style="width:100%;height: 150px;" src="${ctx}/resources/img/noimage.png" alt="" />
                   </div>
		...
		<div class="modal-footer w_save_btn">
