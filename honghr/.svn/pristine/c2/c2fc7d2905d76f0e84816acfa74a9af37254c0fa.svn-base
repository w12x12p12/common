package com.hongedu.honghr.util.chineseChar;
...
public class ChineseInital {
	private final static int[] areaCode = { 
			1601, 1637, 1833, 2078, 2274, 2302, 
			2433, 2594, 2787, 3106, 3212, 3472,
			3635, 3722, 3730, 3858, 4027, 4086, 
	...
	public static String getAllFirstLetter(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			_str = _str + chineseInital.getFirstLetter(str.substring(i, i + 1));
		}
		return _str;
	}
	...
	public static String getFirstLetter(String chinese) {
		...
		chinese = chineseInital.conversionStr(chinese, "GB2312","ISO8859-1");
	...
	public static void main(String[] args) {
		String s = ChineseInital.getAllFirstLetter("测试测试测试");
